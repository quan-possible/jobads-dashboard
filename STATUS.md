...
- The 2026-08-11 redesign exploration now has a durable home at `docs/analyses/labor_market_dashboard/redesign-foundation/`, with separate desktop visual targets, design-system material, source-state UI kit, provenance, and ACLMR brand audit. This groundwork did not change the current application or deployment.
