...
export const industriesDict = {
  en: {
    // Hero
    eyebrow: "Industries",
    hero: "Posted hiring demand by industry sector",
    lede: "A monthly read on posted hiring demand across Canada’s industry sectors (NAICS). Industry coding is incomplete, so every sector total is conditional on coverage. Job ads measure posted demand — not employment or vacancies.",
    ...
    charts: {
      ...
      contributionBars: {
        ...
        note: "Contribution to growth among coded postings (accounting identity), from the 2019 baseline.",
  ...
  fr: {
    // Hero
    eyebrow: "Industries",
    hero: "Demande d’emploi affichée par secteur d’activité",
    lede: "Un bilan mensuel de la demande d’emploi affichée dans les secteurs d’activité au Canada (SCIAN). Le codage sectoriel est incomplet, donc chaque total de secteur est conditionnel à la couverture. Les offres mesurent la demande affichée — non l’emploi ni les postes vacants.",
    ...
    charts: {
      ...
      contributionBars: {
        ...
        note: "Contribution à la croissance parmi les offres codées (identité comptable), depuis la référence 2019.",
