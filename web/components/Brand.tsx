...
export function Brand({ compact = false }: { compact?: boolean }) {
  return (
    <Link href="/" className="group flex items-center gap-3" aria-label="ACLMR Labour Market Dashboard — home">
      ...
      <span className="flex flex-col leading-none">
        ...
        {!compact && (
          <span className="text-[0.62rem] font-bold uppercase tracking-[0.03em] text-ink-soft">
            Labour&nbsp;Market
          </span>
        )}
      </span>
