...
_I18N: dict[str, dict[str, str]] = {
    "en": {
        ...
        "low_sample": "Insufficient data (fewer than 100 postings)",
        "postings": "postings",
        "share": "share of postings",
        "yoy": "change from last year (%)",
        "two_year": "change {a}→{b}",
        "two_year_generic": "change between years",
        "two_year_needs_breakdown": "Choose a category breakdown for two-year change.",
        "two_year_same_year": "Choose two different years.",
        "share_caveat": "share of all postings; excludes uncategorized postings",
    ...
    "fr": {
        ...
        "low_sample": "Données insuffisantes (moins de 100 offres)",
        "postings": "offres",
        "share": "part des offres",
        "yoy": "variation annuelle (%)",
        "two_year": "variation {a}→{b}",
        "two_year_generic": "variation sur deux ans",
        "two_year_needs_breakdown": "Choisissez une répartition par catégorie pour la variation sur deux ans.",
        "two_year_same_year": "Choisissez deux années différentes.",
        "share_caveat": "part de toutes les offres; catégories inconnues exclues",
...
def _build_bar(
    ...
    # Explore is behind the team login, so it always serves the full, uncapped
    # view — no 10-category fold here (that cap is the public contract elsewhere).
