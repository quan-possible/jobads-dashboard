...
- **Depends on:** [2026-06-25-ten-category-cap](../2026-06-25-ten-category-cap/JOB.md) (this job makes that completed cap conditional on auth)
...
**Promotion:** On 2026-08-11, `main` and `origin/main` were moved directly to the new design line at
`65661304`. The obsolete 10-commit Streamlit/worktree-only line was deliberately replaced rather
than merged; it remains recoverable locally as `backup/main-pre-new-design-20260811-3b037d7d`.

**Current verification:** On 2026-08-11, the exact promoted code passed 348 Python tests and a
production Next.js build, including TypeScript and static page generation.

**Remaining:** set `JOBADS_DASHBOARD_PASSWORD(_HASH)` and
