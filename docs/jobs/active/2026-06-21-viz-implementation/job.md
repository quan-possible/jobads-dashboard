...
- **Branch / worktree:** `redesign2` (worktree off `redesign`)
- **Opened:** 2026-06-21
- **Status:** OPEN — full Core→Deep figure catalogue implemented and visually verified on a static review page; not yet wired into the live site.
...
## Open decisions before porting to the live site
