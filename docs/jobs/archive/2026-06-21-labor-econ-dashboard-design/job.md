...
Status: SUPERSEDED by the completed researcher visualization and integration
jobs; retained as historical design evidence only.
Date: 2026-06-21. Scope: researcher plots only.
